  ...
  experience: [
    {
      ...
      results: [
                ...
                '(React, React Native, Nodejs, Firebase, MongoDB, Material UI)' 
              ]
    },
    {
      ...
      results: [
                ...
                '(React Native, Jest, Unix, Nodejs, AWS, MySQL, Jenkins)'
              ]
    },
    {
      company: 'Techdrone',
    ...
    },
    {
      ...
      results: ['Build and Maintain internal workflow app for managing inventory and dispatching technicians.',
                'The ERP system served about 400 technicians, and dozens of support and admin users.',
                ...
                '(Ruby on Rails, Angularjs, PostgresSQL, Rspec)'
              ]
    },
    {
      ...
      results: ['Designed and edited a wordpress for EduMesh, a concept for connecting education systems together.',
                ...
                '(Ruby on Rails, jQuery, Javascript, Backbonejs, CSS3)'
              ]
    },
    {
      company: 'FujiFilm',
      ...
      results: ['Ensure confidence in medical imaging software.  The tool helps radiologists diagnose cancer and other illnesses.',
                ...
                '(Windows, Balsamiq, AutoHotkey, CSS3)',
              ]
    },
  ],
}
