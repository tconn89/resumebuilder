...
export default {
  profile: 'Looking for a crypto/gamer/tenacious company to push my talents forward.',
  ...
  experience: [
    {
      ...
      city: 'Raleigh',
      state: 'NC',
      results: ['Executed on provided UX mockups to create an android app with React Native.',
    ...
    },
    {
      ...
      city: 'Garner',
      state: 'NC',
      results: ['Created Angular directives (javascript) for building forms and handling user interaction.',
                'Cultivated a user preference feature for improved paginated results and better UX.',
                'Build and Maintain internal workflow app for dispatching technicians and their inventory.',
